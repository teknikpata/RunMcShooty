...
CollisionBox::CollisionBox(const sf::Vector2f &position,
...
sf::Vector2f CollisionBox::getPosition() const { return position; }

sf::Vector2f CollisionBox::getSize() const { return size; }

float CollisionBox::getHeight() const { return size.y; }

float CollisionBox::getWidth() const { return size.x; }

float CollisionBox::getRight() const { return position.x + size.x; }

float CollisionBox::getLeft() const { return position.x; }

float CollisionBox::getTop() const { return position.y; }

float CollisionBox::getBottom() const { return position.y + size.y; }
